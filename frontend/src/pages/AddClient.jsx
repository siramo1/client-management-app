    ...
    <div className="min-h-screen bg-gradient-to-b from-cyan-100 to-emerald-100 p-4">
      <div className="max-w-4xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          ...
          <h1 className="text-center text-amber-50 text-3xl p-1 sm:p-5 pl-8 pr-8 w-fit bg-gradient-to-r from-green-700 to-emerald-400 border-4 border-orange-600 rounded-2xl  ml-4 sm:ml-0">
            Add New Client
          </h1>
          ...
          <form onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <div className="mb-4">
                  <label className="block text-emerald-800 font-bold mb-2">Name/ስም *</label>
                  <input
                    type="text"
                    name="name"
                    value={formData.name}
                ...
                <div className="mb-4">
                  <label className="block text-emerald-800 font-bold mb-2">Phone Number/ቁ-ሞባይል</label>
                  <input
                    type="number"
                    name="phoneNumber"
                ...
                <div className="mb-4">
                  <label className="block text-emerald-800 font-bold mb-2">Note Number/ቁ-መዝገብ</label>
                  <input
                    type="number"
                    name="noteNumber"
                ...
                <div className="mb-4">
                  <label className="block text-emerald-800 font-bold mb-2">Type/ዓይነት</label>
                  <input
                    type="text"
                    name="whatType"
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                    {Object.entries(formData.size[0]).map(([field, value], index) => (
                        <div key={field} className={`mb-4 ${index % 2 === 0 ? 'pr-2' : 'pl-2'}`}>
